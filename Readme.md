...
Beneath all security concerns (everybody in the network of user X can login as user X...IP spoofing not even mentioned) there's really a right of exist for this provider plugin in our environment. Believe me. But if you are about to set up the OpenID login for a finance portal: Please do not use this!
